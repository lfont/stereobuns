...
define([
  ...
  function keyboardShortcutDrtFactory ($document, $parse) {
    var keysByCode = {
      8: 'backspace',
      9: 'tab',
      13: 'enter',
    ...
    return {
      ...
      link: function (scope, iElement, iAttrs) {
        var params = scope.$eval(iAttrs.srKeyboardShortcut);
  ...
  keyboardShortcutDrtFactory.$inject = [ '$document', '$parse' ];

  return keyboardShortcutDrtFactory;
});
